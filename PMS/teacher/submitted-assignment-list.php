		...
		<nav class="navbar navbar-expand-lg navbar-light bg-light">
		  ...
		  <div class="collapse navbar-collapse" id="navbarSupportedContent">
		    <ul class="navbar-nav mr-auto">
		      ...
		      <li class="nav-item active">
		        <a class="nav-link" href="students-list.php">Student List</a>
		      </li>
		      <li class="nav-item active">
		...
		<div class="card text-center" style="margin-top: 80px;">
		  <div class="card-header bg-dark">
		    <ul class="nav nav-tabs card-header-tabs">
		      <li class="nav-item">
		        <a class="nav-link active" href="#">Submitted Project List</a>
		      </li>
		    </ul>
		  </div>
		  <div class="card-body">
		    <h5 class="card-title">Submitted Project List</h5>
			  ...
			  <thead>
			    <tr>
			      ...
			      <th scope="col">Student ID</th>
                                            ...
                                            $query = "select * from assignment where status = '1' order by 1 DESC";
